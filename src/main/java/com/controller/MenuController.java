...
public class MenuController {
    ...
    @Autowired
    private JiaogongjiluService jiaogongjiluService;//工作记录
    @Autowired
    ...
    */
    ...
    public R save(@RequestBody MenuEntity menu, HttpServletRequest request){
        ...
        if(menuEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",menu.toString());
            return R.ok();
        }else {
...
//            return R.error(511,"永远不会进入");
        menu.setUpdateTime(new Date());
            ...
            List<String> strings = caozuorizhiService.clazzDiff(menu, oldMenuEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldMenuList.toString());
        return R.ok();
    }
...
//                            menuEntity.setCreateTime(date);//时间
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",menuList.toString());
                        return R.ok();
                    }
                }
            }
